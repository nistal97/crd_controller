...
import (
	scheme "crd_controller/pkg/generated/clientset/versioned/scheme"
	"time"
...
// CiConfigsGetter has a method to return a CiConfigInterface.
// A group's client should implement this interface.
type CiConfigsGetter interface {
	CiConfigs(namespace string) CiConfigInterface
}
...
// ciConfigs implements CiConfigInterface
type ciConfigs struct {
	client rest.Interface
	ns     string
}

// newCiConfigs returns a CiConfigs
func newCiConfigs(c *TessV1Client, namespace string) *ciConfigs {
	return &ciConfigs{
		client: c.RESTClient(),
		ns:     namespace,
	}
